...
class WebhookDetailPage extends Component {
  ...
  handlePageOnLoad() {
    ...
    console.log('Handle page on load -----------------> 111');
    ...
    console.log('Handle page on load -----------------> 222');
  }
  ...
  handleCheckboxChange = (event, name) => {
    this.setState((prevData) => {
      const newData = { ...prevData };
      newData.main_data[name] = event.target.checked;
      return newData;
    });
  };

  handleInputChangeWithValue = (event, name, value) => {
    this.setState((prevData) => {
      const newData = { ...prevData };
      newData.main_data[name] = value;
      return newData;
    });
  };
  ...
  handleSubTextValueChange = (event, name1, name2, index) => {
    ...
    if (fieldIndex !== -1) {
      this.setState((prevData) => {
        const newData = { ...prevData };
        newData.main_data.fields[fieldIndex].list[index][name2] =
          event.target.value;
        return newData;
      });
    }
  ...
  handleWebhookRefresh = () => {
    this.postRequest(
      '/api/webhook/load_webhook_response',
      this.startLoading,
      this.stopLoading,
      this.sucessCallBackWebhookRefresh,
      this.state.main_data
    );
  };
  ...
  sucessCallBackLoad = (resp) => {
    this.setState((prevData) => {
      ...
      newData.job_file_content = resp.job_file_content;
      newData.job_file_content_columns = resp.job_file_content_columns;
      newData.loading = false;
      return newData;
    });
  };
      ...
      <Grid className="landing-page" fullWidth>
        ...
        {this.state.main_data && (
          <Column lg={16} md={8} sm={4} className="landing-page__r2">
                      ...
                      <tr>
                        <td className="my-textbox-row">
                          <TextInput
                            ...
                            onChange={(e) =>
                              this.handleInputChange(e, 'firewall_url')
                            }
                          />
                        </td>
                      </tr>
                      <tr>
                        <td className="my-textbox-row">
                          <TextInput
                            ...
                            onChange={(e) =>
                              this.handleInputChange(e, 'firewall_user')
                            }
                          />
                        </td>
                      </tr>
            ...
            <div className="my-component">
              <section className="top-section">
                <div className="text-sub-heading">Job Scheduling</div>
                {/* <div className="text-sub-heading-label2">
                        Envizi AWS S3 access details
                      </div> */}
                <div className="upload-section">
                  <table>
                    <tr>
                      <td>
                        <Toggle
                          id="scheduler-toggle"
                          labelText="Scheduler On/Off"
                          labelA="Off"
                          labelB="On"
                          toggled={this.state.main_data.isSchedulerOn}
                          onToggle={(e) =>
                            this.handleInputChangeWithValue(
                              e,
                              'isSchedulerOn',
                              !this.state.main_data.isSchedulerOn
                            )
                          }
                        />
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <TextInput
                          ...
                          value={this.state.main_data.startDate}
                          // size="md"
                          onChange={(e) =>
                      ...
                      <td>
                        <TextInput
                          ...
                          value={this.state.main_data.startTime}
                          // size="md"
                          onChange={(e) =>
                    ...
                    <tr>
                      ...
                      <td>
                        <TextInput
                          className="fin-text-box1"
                          labelText="End Date"
                          value={this.state.main_data.endDate}
                          // size="md"
                      ...
                      <td>
                        <TextInput
                          className="fin-text-box1"
                          labelText="End Time"
                          value={this.state.main_data.endTime}
                          // size="md"
                          onChange={(e) => this.handleInputChange(e, 'endTime')}
                        ></TextInput>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <TextInput
                          className="fin-text-box1"
                          labelText="Interveal"
                          value={this.state.main_data.interval}
                          // size="md"
                          onChange={(e) =>
                            this.handleInputChange(e, 'interval')
                          }
                        ></TextInput>
                      </td>
                      <td></td>
                      ...
                      <tr>
                        <td className="my-textbox-row">
                          <Dropdown
                            ...
                            onChange={(e) =>
                              this.handleEnviziTemplateDropDownChange(
                                e,
                                'envizi_template'
                              )
                            }
                      ...
                      <tr>
                        <td className="my-textbox-row">
                          <Dropdown
                            ...
                            selectedItem={
                              this.state.main_data.data_template_type
                            }
                            onChange={(e) =>
            ...
            <div className="my-component">
              <section className="top-section">
                ...
                {
                  <div className="text-sub-heading-label2">
                    Preview the Envizi data generated based on the Webhook
                    mapping and Ingest into Envizi
                  </div>
                }
                          ...
                          <div className="fin-mapping-container">
                            <div className="fin-row">
                              <div className="fin-column">
                                <Button
                                  className="fin-button-1"
                                  onClick={this.handleViewInScreen}
                                >
                                  Preview{' '}
                                </Button>
                              </div>
                          ...
                          {this.state.resultIngest &&
                            this.state.resultIngest.processed_data && (
                              <span>
                                <CarbonTable
                                  columns={
                                    this.state.resultIngest.template_columns
                                  }
                                  jsonData={
                                    this.state.resultIngest.processed_data
                                  }
            ...
            <div className="my-component">
              <section className="top-section">
                <div className="text-sub-heading">Job Content</div>
                {
                  <div className="text-sub-heading-label2">
                    Job Content list
                  </div>
                ...
                <div className="upload-section">
                  <table className="full-width-table">
                    <tbody>
                      <tr>
                        <td className="my-textbox-row">
                          {this.state.job_file_content && (
                            <span>
                              <CarbonTable
                                columns={this.state.job_file_content_columns}
                                jsonData={this.state.job_file_content}
                                headingText1={'Jbo content'}
                                headingText2={
                                  'The below data would be job content'
                                }
                              />
                            </span>
                          )}
